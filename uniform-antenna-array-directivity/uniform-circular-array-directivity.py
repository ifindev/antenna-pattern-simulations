...
N=10
d=2*la
 #distance between array element follow wavelength
deltax=0


#Array Factor Calculation
psi=(k*d*sin(THETA))+deltax

AF=0

for m in range(1,M + 1):
    AF=AF + exp(j*cos(PHI-(m-1)*2*pi/N)*psi)
...
ax.set_title('Directivity UCA (d = 2$\lambda$)',size=20)
